...
#4.2
L = [1,1,1,2,2,3,3,3,4,4,5,5,6,6,6,9,9,10,11,12,15]#Solution: [0,3,4,5,6,9,15], [0,6,9,10,11,12,15]

#Example from algorithm description
#L = [2,2,3,3,4,5,6,7,8,10]#Solution: [0,2,4,7,10], [0,3,6,8,10]

#Internet examples
#L = [1,5,6,7,11,12]#Solution: [0,1,7,12],[0,5,11,12]
